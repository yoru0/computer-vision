...
def train_test_model():
    ...
    face_recognizer.write("model_v4.xml")


def predict_image():
    if not os.path.exists("model_v4.xml"):
        print("Model not found")
        return

    face_recognizer.read("model_v4.xml")
    image_path = input("Enter the path to the image for testing (Absolute Path): ")
